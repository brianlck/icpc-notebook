...
struct LazySegmentTree {
  ...
  void _update (int ql, int qr, U v, int l, int r, int i) {
    propagate(l, r, i);
    if (qr < l || r < ql) return;
    if (ql <= l && r <= qr) {
